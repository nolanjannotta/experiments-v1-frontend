  ...
  return (
    <article>
        ...
        <p>
            ...
            for onchain art directly from the creater/artist. 
            As of now though, this depends entirely on whether theres any interest whatsoever from collectors. 
    ...
    <figcaption>Goals:</figcaption>
        ...
        <li>All payments, royalties etc and as much business logic as possible will take place on chain. Things like shipping addresses will need to be handled elsewhere, possibly Coinbase Commerce or Slice?</li>
        ...
        <li>
          Another idea is generative stationary. Using the same art generator contracts and a random seed, 
          print 1/1 generative stationary or post cards. Sold in packs of 10 with envelopes and 
          a <i>global forever stamp for each card.</i> Easily send physical 1/1 art to people you like!    
          </li>
